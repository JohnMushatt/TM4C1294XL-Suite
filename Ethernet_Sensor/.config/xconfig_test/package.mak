...
package/%.xdc.inc package/%_xconfig_test.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_test" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: test.pem4f

-include package/cfg/test_pem4f.mak
-include package/cfg/test_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/test_pem4f.dep
endif
test.pem4f: package/cfg/test_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
test.pem4f package/cfg/test_pem4f.c: .libraries,em4f
endif

package/cfg/test_pem4f.c package/cfg/test_pem4f.h package/cfg/test_pem4f.xdl: override _PROG_NAME := test.xem4f
package/cfg/test_pem4f.c: package/cfg/test_pem4f.cfg
package/cfg/test_pem4f.xdc.inc: package/cfg/test_pem4f.xdl
package/cfg/test_pem4f.xdl package/cfg/test_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/test_pem4f.cfg
	-$(RM) package/cfg/test_pem4f.dep
	-$(RM) package/cfg/test_pem4f.c
	-$(RM) package/cfg/test_pem4f.xdc.inc

clean,em4f::
	-$(RM) test.pem4f
.executables,em4f .executables: test.xem4f

test.xem4f: |test.pem4f

-include package/cfg/test.xem4f.mak
test.xem4f: package/cfg/test_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/test_pem4f.oem4f   package/cfg/test_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
test.xem4f: export C_DIR=
test.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
test.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

test.test test,em4f test: test.xem4f.test

test.xem4f.test:: test.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 test.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.test.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,test.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
test_pem4f.oem4f,copy : package/cfg/test_pem4f.oem4f
test_pem4f.sem4f,copy : package/cfg/test_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_test
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_test.tar.dep
endif
package/rel/xconfig_test/xconfig_test/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_test/xconfig_test/package/package.rel.xml: package/build.cfg
package/rel/xconfig_test/xconfig_test/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_test/xconfig_test/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_test.tar: package/rel/xconfig_test.xdc.inc package/rel/xconfig_test/xconfig_test/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_test.xdc.inc,package/rel/xconfig_test.tar.dep)


release release,xconfig_test: all xconfig_test.tar
clean:: .clean
	-$(RM) xconfig_test.tar
	-$(RM) package/rel/xconfig_test.xdc.inc
	-$(RM) package/rel/xconfig_test.tar.dep
